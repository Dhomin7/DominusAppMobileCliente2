 ...
 FragmentDptoBinding binding;
    ...
    DptoAdapter.DepartamentoOnClickListener trataCliqueItem = new DptoAdapter.DepartamentoOnClickListener() {
        ...
        public void onClickDepartamento(View view, int position, Departamento departamento) {
            /* public void onClickProduto(View view, int position, Departamento departamento) {
            DominusApp.view.DptoFragmentDirections.AcaoDptoFragmentProdutoFragment acao =
                    DptoFragmentDirections.acaoDptoFragmentProdutoFragment(departamento);
